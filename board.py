    ...
    def is_move_valid(self, player_number, i, j):
        ...
        for row_coeff in range(-1, 2):
            for column_coeff in range(-1, 2):
                ...
                is_valid = False
                while row >= 0 and row < self.__n and column >= 0 and column < self.__n and self.__board_grid[row][
                    column] != -1:
    ...
    def is_imaginary_move_valid(self, player_number, i, j):
        ...
        for row_coeff in range(-1, 2):
            for column_coeff in range(-1, 2):
                ...
                column = j + column_coeff * k
                is_valid = False
                while row >= 0 and row < self.__n and column >= 0 and column < self.__n and \
                        self.imaginary_board_grid[row][column] != -1:
